...
/**
 * 场所安全状况评定分档线 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITSportSafetyStdService {

    /** 按主键查询规则 */
    TSportSafetyStd selectTSportSafetyStdById(Long id);
    ...
    List<TSportSafetyStd> listAvailable(Date at);
