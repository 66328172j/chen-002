...
/**
 * 经营场所档案对象 t_sport_venue
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sport_venue")
@ApiModel(value = "TSportVenue", description = "经营场所档案")
public class TSportVenue implements Serializable {
    ...
    @ApiModelProperty(value = "经营项目类别")
    private String siteType;

    /** 所属监管辖区 */
    @TableField("road_name")
    @ApiModelProperty(value = "所属监管辖区")
    private String roadName;

    /** 本工程核定一档泳客人数上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "本工程核定一档泳客人数上限")
    private BigDecimal th1Max;

    /** 二档泳客人数上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "二档泳客人数上限")
    private BigDecimal th2Max;

    /** 三档泳客人数上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "三档泳客人数上限")
    private BigDecimal th3Max;

    /** 档案状况 0在用 1已注销 */
    @TableField("status")
    @ApiModelProperty(value = "档案状况 0在用 1已注销")
