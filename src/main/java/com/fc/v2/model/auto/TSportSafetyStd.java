...
/**
 * 场所安全状况评定分档线对象 t_sport_safety_std
 *
 * @author fuce
 * @date 2026-09-12
 */
@TableName("t_sport_safety_std")
@ApiModel(value = "TSportSafetyStd", description = "场所安全状况评定分档线")
public class TSportSafetyStd implements Serializable {
    ...
    @ApiModelProperty(value = "评定线代号")
    private String ruleCode;

    /** 评定线名称 */
    @TableField("rule_name")
    @ApiModelProperty(value = "评定线名称")
    private String ruleName;

    /** 一档得分上限 */
    @TableField("th1_max")
    @ApiModelProperty(value = "一档得分上限")
    private BigDecimal th1Max;

    /** 二档得分上限 */
    @TableField("th2_max")
    @ApiModelProperty(value = "二档得分上限")
    private BigDecimal th2Max;

    /** 三档得分上限 */
    @TableField("th3_max")
    @ApiModelProperty(value = "三档得分上限")
    private BigDecimal th3Max;

    /** 启用时刻 */
    @TableField("eff_start")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "启用时刻")
    private Date effStart;

    /** 交棒时刻(不含) */
    @TableField("eff_end")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    @ApiModelProperty(value = "交棒时刻(不含)")
    private Date effEnd;
    ...
    /** 评定线状况 0在用 1已交出 */
    @TableField("status")
    @ApiModelProperty(value = "评定线状况 0在用 1已交出")
